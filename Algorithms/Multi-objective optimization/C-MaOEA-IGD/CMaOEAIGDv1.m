classdef CMaOEAIGDv1 < ALGORITHM
...
methods
        function main(Algorithm,Problem)
            ...
            Population = Problem.Initialization();
            [Population,Rank,Dis] = EnvironmentalSelectionv1(Population,W,Problem.N);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                [Population,Rank,Dis] = EnvironmentalSelectionv1([Population,Offspring],W,Problem.N);
            end
        end
    end
end
