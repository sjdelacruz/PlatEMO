classdef MaOEAIGDDR0 < ALGORITHM
    ...
    methods
        function main(Algorithm,Problem)
            ...
            Population = Problem.Initialization();
            [Population,Rank,Dis] = EnvironmentalSelection(Population, W, Problem.N, c, beta, alfa, 0);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                %The mating pool is done based on the ranks and minimum
                %distances
                ...
                [Population,Rank,Dis] = EnvironmentalSelection([Population,Offspring],W,Problem.N, c, beta, alfa, currentGen-1);
