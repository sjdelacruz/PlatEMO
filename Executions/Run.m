...
Algorithms(3) = GenerateAlgorithm(@CTAEA, 'Two-archive evolutionary algorithm',100,{});
Algorithms(4) = GenerateAlgorithm(@CCMO, 'Coevolutionary framework',100,{});
Algorithms(5) = GenerateAlgorithm(@MOEADDAE, 'MOEAD with detect-and-escape strategy',100,{});
Algorithms(6) = GenerateAlgorithm(@ANSGAIII, 'Adaptive NSGAIII',100,{});
Algorithms(7) = GenerateAlgorithm(@TiGE2, 'Three indicators',100,{});
